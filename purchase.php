            ...
            <div class="container-fluid">
                <table class="table">
                    ...
                    foreach ($_SESSION['cart'] as $isbn => $qty) {
                        ...
                        $bookQuantity = getBookQuantityByIsbn($conn, $isbn);

                       
                        if ($bookQuantity >= $qty) {
                           
                            $newQuantity = $bookQuantity - $qty;
                            updateBookQuantity($conn, $isbn, $newQuantity);
                        } else {
                            
                            echo "<p class='text-danger'>Error: The book '{$book['book_title']}' does not have enough quantity.</p>";
                        }
                        ?>
                        <tr>
                        ...
                        <form method="post" action="process.php" class="form-horizontal">
                            ...
                            <div class="form-group mb-3">
                                <div class="d-grid gap-2">
                                    ...
                                    <button type="reset"
                                            class="btn btn-default bg-light bg-gradient border rounded-0">Cancel
                                    </button>
                                </div>
                            </div>
                        </form>
                        <p class="fw-light fst-italic"><small class="text-muted">Please press Purchase to confirm your
