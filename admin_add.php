<?php
	...
	if (isset($_POST['add'])) {
		...
		$query = "INSERT INTO books (`book_isbn`, `book_title`, `book_author`, `book_image`, `book_descr`, `book_price`, `publisherid`, `quantity`) 
			VALUES ('" . $isbn . "', '" . $title . "', '" . $author . "', '" . $image . "', '" . $descr . "', '" . $price . "', '" . $publisherid . "', '" . $quantity . "')";
				...
				<div class="container-fluid">
					...
					<form method="post" action="admin_add.php" enctype="multipart/form-data">
						...
						<div class="mb-3">
							...
							<textarea class="form-control" name="descr" cols="40" rows="5"></textarea>
						</div>
						<div class="mb-3">
						...
						<div class="text-center">
							<button type="submit" name="add" class="btn btn-primary rounded-0">Save</button>
							<button type="reset" class="btn btn-default rounded-0 border">Cancel</button>
						</div>
					</form>
				</div>
			</div>
